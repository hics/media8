...
@interface PocketGuideObject : KrollCoverageObject {
#else
@interface PocketGuideObject : KrollObject {
#endif
@private
...
extern NSString * PocketGuide$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PocketGuideObject *_pocketguide;
    KrollObject* console;
	BOOL shutdown;
