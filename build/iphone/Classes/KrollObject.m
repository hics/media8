 ...
 * Copyright (c) 2009-2011 by PocketGuide, Inc. All Rights Reserved.
...
//@interface PocketGuideObject : NSObject
//@end

@interface PocketGuideObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PocketGuideObject class]])
		{
			for (NSString *key in [[(PocketGuideObject*)o modules] allKeys])
			{
