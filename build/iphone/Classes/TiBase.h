...
// in simulator we redefine to format for PocketGuide Developer console
...
{\
	NSString * exceptionName = [@"org.pocketguide." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pocketguide";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPocketGuideNativeItemNone = -1, 
	UIPocketGuideNativeItemSpinner = -2,
	UIPocketGuideNativeItemProgressBar = -3,
	
	UIPocketGuideNativeItemSlider = -4,
	UIPocketGuideNativeItemSwitch = -5,
	UIPocketGuideNativeItemMultiButton = -6,
	UIPocketGuideNativeItemSegmented = -7,
	
	UIPocketGuideNativeItemTextView = -8,
	UIPocketGuideNativeItemTextField = -9,
	UIPocketGuideNativeItemSearchBar = -10,
	
	UIPocketGuideNativeItemPicker = -11,
	UIPocketGuideNativeItemDatePicker = -12,
	
	UIPocketGuideNativeItemInfoLight = -13,
	UIPocketGuideNativeItemInfoDark = -14,
	
	UIPocketGuideNativeItemDisclosure = -15,
	
	UIPocketGuideNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PocketGuide instances of
