...
/**
 The base class for all PocketGuide modules
 */
...
/**
 PocketGuide Platform calls this method on startup.
 */
-(void)startup;

/**
 PocketGuide Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PocketGuide Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PocketGuide Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 PocketGuide Platform calls this method on resume.
 @param sender The sender of the event.
 */
