...
/**
 Base class for all PocketGuide views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PocketGuide view hierarchy (such as wrapped iOS UIViews) was touched.
