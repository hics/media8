...
static NSString * const kPocketGuideJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_pocketguideInjection
{
	...
	[html appendString:kPocketGuideJavascript];
...
{
	// attempt to make well-formed HTML and inject in our PocketGuide bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _pocketguideInjection]];
